#!/usr/bin/env python3
"""
ImageNet Pretrained Model Evaluation Script - Simplified Version
Evaluates pretrained ECCV16 and SIGGRAPH17 models on ImageNet dataset
"""
...
class ImageNetPretrainedEvaluator:
    ...
    def colorize_with_pretrained_model(self, image_path, model, model_name):
        """Colorize using pretrained model with original preprocessing"""
        try:
            # Load and preprocess image using original method
        ...
        for batch_idx, (rgb_image, class_name, image_path) in enumerate(dataloader):
            ...
            try:
                ...
                if colorized_img is not None:
                    ...
                    print(f"Failed to colorize image: {image_path}")
